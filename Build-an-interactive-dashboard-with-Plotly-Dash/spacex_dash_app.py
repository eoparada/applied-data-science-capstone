...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fdata=data.groupby('class').count().reset_index()
        fig = px.pie(fdata, values='Flight Number', 
            names='class', 
...
# Add computation to callback function and return scatter plot
def get_scatter_chart(entered_site, value_range):
